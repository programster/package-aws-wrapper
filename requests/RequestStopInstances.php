...
class RequestStopInstances extends Ec2RequestAbstract
{
    ...
    public function __construct(string ...$instance_ids)
    {
        ...
        {
            $errMsg = get_called_class() . ': need to provide at least one string ID of an instance to stop.';
    ...
    {
        $response = $ec2->stopInstances($opt);
        return $response;
    }
}
