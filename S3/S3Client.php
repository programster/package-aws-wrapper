...
class S3Client
{
     ...
     * @param Acl $acl - the ACL to store the file with. If set to null, then an ACL will not be sent in the request.
     *                   Refer to the ACL Object. You must have WRITE_ACP to be able to set the ACL of an object.
